...
For `citegres`, security-sensitive reports should be handled privately by the repository owner.
...
- Never commit `citegres.ini`, database credentials, or host-specific connection details.
